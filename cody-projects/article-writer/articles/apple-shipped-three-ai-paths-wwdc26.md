...
date: 2026-06-16
description: "A builder's decision map for Apple's WWDC26 AI stack: when to reach for the Foundation Models framework, Core AI, or MLX, where App Intents fits, and how it all works inside the newly agentic Xcode 27."
keywords: [wwdc26, apple intelligence, foundation models framework, core ai, mlx, app intents, xcode 27, on-device ai, afm 3, private cloud compute]
