...
date: 2026-06-29
description: "At Figma Config 2026, new materials like motion, depth, texture, and code grabbed the spotlight. But AI is the quiet engine making them, and it never leaves the canvas."
keywords: [figma config 2026, figma ai, ai in design tools, figma motion, code layers, figma agent, shaders, embedded ai, ai as a feature not a tool, building with ai]
...
[^1]: Figma (2026). "Config 2026: New Materials, New Tools and a More Expressive Canvas." *Figma Blog*. https://www.figma.com/blog/config-2026-recap/
...
[^3]: Ivan Mehta (2026). "Figma adds code layers, support for animations, more AI features in new update." *TechCrunch*. https://techcrunch.com/2026/06/24/figma-adds-code-layers-support-for-animations-more-ai-features-in-new-update/
